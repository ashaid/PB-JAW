...
def edge_list_getter(building):
    ...
    #        (10, 9, 2), (11, 10, 2)
    #    ])
    # elif building == "loc-2": //or whatever locket's 2nd floor is called
    #   edge_list = np.array([
    #        (2, 284, 1), (1, 285, 1), (2, 282, 1), (4, 280, 1), (5, 276, 1), (5, 277, 1),
    #        (6, 237, 1), (6, 239, 1), (11, 235, 1), (11, 241, 1), (10, 243, 1), 
    #        (10, 244, 1), (9, 240, 1), (7, 232, 1), (7, 9997, 2), (1, 9998, 2), (8, 7,  2),
    #        (9, 8, 2), (10, 9, 2), (11, 8, 2), (2, 1, 2), (3, 2, 2), (4, 3,  2), (5, 4, 2),
    #        (6, 3, 2)
    #    ])
    # elif building == "loc-b": //or whatever locket's basement is called
    #   edge_list = np.array([
    #        (1, 002, 1), (10, 005, 1), (2, 006, 1), (9, 009, 1), (3, 010, 1), (7, 015, 1),
    #        (1, 016, 1), (1, 9999, 2), (2, 1, 2), (3, 2, 2), (4, 3,  2), (11, 4, 2), (5, 11, 2),
    #        (6, 5, 2), (7, 6, 2), (8, 7, 2), (9, 8, 2), (10, 9, 2), (10, 1,  2)
    #    ])
