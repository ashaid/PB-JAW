...
def edge_list_getter(building):
    ...
    if building == "bec":
        ...
        edge_list = np.array([
            ...
            (7, 1245, 1), (4, 1253, 1), (16, 1360, 1), (12, 9997, 2), (12, 17, 2), (10, 9999, 2),
            (9999, 1, 2), (1, 2, 2), (3, 2, 2), (13, 3, 2), (14, 13, 2), (4, 3, 2), (5, 4, 2),
            (6, 5, 2), (12, 5, 2), (11, 9997, 2), (11, 9, 2), (9, 8, 2), (8, 7, 2), (7, 5, 2),
            (10, 9, 2), (16, 15, 2), (17, 16, 2), (9998, 17, 2), (11, 15, 2)
        ])
        ...
        edge_list = np.array([
            ...
            (12, 2352, 1), (11, 2354, 1), (11, 2355, 1), (11, 2356, 1), (10, 2367, 1), (9, 2261, 1),
            (9, 2262, 1), (14, 2304, 1),
            ...
            (34, 33, 2), (33, 32, 2), (32, 31, 2), (31, 30, 2), (30, 29, 2), (29, 28, 2), (29, 27, 2), (24, 14, 2), (14, 37, 2), (37, 2326, 1), (37, 2308, 1)
        ])
